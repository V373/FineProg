...
class ResNet18Conv(ConvBase):
    ...
    def __init__(
        ...
        Args:
            ...
            freeze (bool): if True, freeze the ResNet18 convolution backbone.
            imagenet_norm (bool): if True, apply ImageNet mean / std normalization in forward pass.
        """
    ...
    def train(self, mode=True):
        super(ResNet18Conv, self).train(mode)
    ...
    def __repr__(self):
        ...
        return header + '(input_channel={}, input_coord_conv={}, pretrained={}, freeze={}, imagenet_norm={})'.format(
            self._input_channel,
